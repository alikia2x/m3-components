...
M3 Components uses [Tailwind CSS](https://tailwindcss.com/) for styling. To ensure styles work correctly, first [install Tailwind CSS](https://tailwindcss.com/docs/installation/framework-guides/solidjs) in your project.

After installation, import the M3 Components stylesheet:

```javascript
import "@m3-components/solid/dist/index.css";
```
...
**Note:** Since we use Tailwind CSS for styling, any `class` you specify will be applied **after** the component's pre-defined class names.
